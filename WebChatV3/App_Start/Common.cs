...
public static class Common
{
    ...
    public static string AutoGeneratedServerCode(long IDUser)
    {
        string strCode = IDUser.ToString("D5") + DateTime.Now.ToString("MMddyyHHmmss");
        byte[] utf8Code=Encoding.UTF8.GetBytes(strCode);
        return Convert.ToBase64String(utf8Code);
    }
}